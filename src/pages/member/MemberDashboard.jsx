...
function OverviewSub({ profile, activeBookings, nutrition, notifications, toast, setActiveBookings }) {
  ...
  const upcomingCoaching = activeBookings.filter(b => b.type === 'trainer');
...
/* ============================================================================
   ...
   ============================================================================ */
function SettingsSub({ profile, toast }) {
  ...
  const handleSaveSettings = (e) => {
    e.preventDefault();
    toast.success('App configuration preferences saved successfully.');
  };

  return (
    <form onSubmit={handleSaveSettings} className="glass-card p-6 rounded-2xl border border-gym-gray-800 bg-gym-gray-900/40 space-y-6 max-w-xl mx-auto">
      <h3 className="text-sm font-bold uppercase tracking-widest text-white border-b border-gym-gray-800 pb-3 flex items-center gap-2">
        <FiSettings className="text-primary" /> Application Preferences
      </h3>
      ...
      <div className="space-y-4">
        <div className="space-y-1.5">
          ...
          >
            ...
            <option value="Imperial (lbs/ft)">Imperial (lbs / ft)</option>
          </select>
        </div>
        ...
        <div className="border-t border-gym-gray-850 pt-4 space-y-3">
          <span className="text-[10px] text-gym-gray-450 uppercase tracking-widest font-black block">Alert Channels</span>
          <div className="space-y-2">
            <label className="flex items-center gap-3 cursor-pointer select-none">
              ...
              />
              <span className="text-xs text-gym-gray-300">Enable Email Notification Summary</span>
            </label>
            <label className="flex items-center gap-3 cursor-pointer select-none">
              <input 
                type="checkbox" 
              ...
              />
              <span className="text-xs text-gym-gray-300">Enable Dashboard In-App Audio Ping</span>
            </label>
            <label className="flex items-center gap-3 cursor-pointer select-none">
              <input 
                type="checkbox" 
